      ...
      <div className={`lifewear-grid ${inView ? 'is-in-view' : ''}`} ref={ref}>
        ...
        <div className="collection-item yogawear">
          ...
          <div className="collection-overlay">
            ...
            <a href="#yogawear" className="collection-button">Ver Colección</a>
          </div>
        </div>
        ...
        <div className="collection-item knitwear">
          ...
          <div className="collection-overlay">
            ...
            <a href="#knitwear" className="collection-button">Ver Colección</a>
          </div>
        </div>
        ...
        <div className="collection-item archivo">
          ...
          <div className="collection-overlay">
            ...
            <a href="#archivo" className="collection-button">Ver Colección</a>
          </div>
        </div>
      </div>
    </section>
